...
head(iris)
#Data needs reshaping. It is long and contains Length and Width measurements for plant parts (Petal & Sepal) as separate columns. Measurements will be merged and plant part information provided as a value in a new column.
...
head(iris_melted) 
#all measurements are now found in the "value" column with data variables indicated in column "variables"
...
head(iris_cast) #data frame in desired format
